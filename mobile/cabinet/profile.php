...
<form action='profile.php' method='post'  data-ajax='false'>
	...
	<br>
	<font class='warning_st1'>Изменить имя или почту можно только через службу поддержки</font> - <font class='info_st1'><a href='".$url."/mobile/cabinet/massages.php?to=000&ads=000' rel='external'>написать в службу поддержки</a></font>
		<hr>
