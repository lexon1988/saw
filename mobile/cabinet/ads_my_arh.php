...
for($i=0;$i<$ads_count; $i++){
	...
	<br>
		...
		<a href='ads_my_arh.php?id=".$ads[$i]['id']."'  rel='external' class='ui-btn ui-shadow ui-corner-all ui-icon-back ui-btn-icon-notext ui-btn-b'>back</a>
		<a href='ads_edit_arh.php?id=".$ads[$i]['id']."'  rel='external' class='ui-btn ui-shadow ui-corner-all ui-icon-edit ui-btn-icon-notext ui-btn-b'>edit</a>
