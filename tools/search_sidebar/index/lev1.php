...
<input type='submit' class='button' value='Найти'> <br><br>
<b style='color:#5d6b7a'><a href='index.php?reset=1'> <i class='fa fa-refresh' aria-hidden='true'></i> Обновить форму</a></b>
